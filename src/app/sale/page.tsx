...
const sale = () => {
    ...
    return(
        ...
        <div className="bg-[#E7E8EC] min-h-screen w-full py-5">
            <Header />
            <div className="pt-[38px] md:pt-[72px]">
                <BannerCarousel imgLarge={imgs.imgLarge} imgSmall={imgs.imgSmall}  />
            </div>
            <div className="flex flex-col items-center justify-center w-full">
                <p className="text-blue-900 bg-indigo-200 rounded-full md:p-4 p-2 mx-2 my-8 text-[17px] lg:w-1/5 font-bold text-center">POR QUE VENDER E COMPRAR CONOSCO?</p>
                ...
                <div className="flex flex-col items-center gap-4 my-5">
                    ...
                    <p className="text-blue-600 text-xl text-center p-2">Aqui você encontra mais do que veículos — encontra confiança!</p>
                </div>


                <div className="flex flex-wrap justify-center items-center my-10 gap-12">
                    <div className="bg-white flex flex-col rounded-xl items-center gap-4 shadow p-4 w-55 py-8">
                ...
                <div className="bg-gradient-to-r from-blue-600 to-cyan-400 flex flex-col p-2 justify-center items-center rounded-2xl mx-2 md:w-3/4 lg:w-2/4 gap-6 py-10">
                    ...
                    {width &&
                        (width > 500? (
                            <Button variant="contained" color="inherit" sx={{display:'flex', gap:3, borderRadius:10, padding: 2}}>
                ...
                <div className="flex flex-col md:flex-row m-2 gap-3 bg-gray-300 p-4 rounded-2xl border-l-6 border-l-blue-600">
